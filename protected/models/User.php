...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, password, name, email, address, phone, awsaccesskey, awssecretkey', 'required'),
			...
			array('id, username, password, name, email, address, phone, awsaccesskey, awssecretkey', 'safe', 'on'=>'search'),
		);
	}
